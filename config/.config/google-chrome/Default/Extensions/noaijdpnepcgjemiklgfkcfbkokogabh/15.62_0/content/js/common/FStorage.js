...
FExtension.store = {
    SL_BR_LN: "en",
    SL_PR_ALL: "Google,Microsoft,Translator",
    SL_PR_KEYS: "Google:1,Microsoft:0,Translator:0",
    SL_PR_IT: "Google,Microsoft",
...
//            FExtension.store.SL_BR_LN=FExtension.store.SL_CUR_LANG();
	    ...
	    FExtension.store.set("SL_session", 0);
            //--------------------NEW HOTKEYS-------------------------------------------------------
	    ...
	    if(FExtension.store.get("SL_ENABLE")==null) 	     FExtension.store.set("SL_ENABLE", "true");
		...
		if(FExtension.store.get("SL_global_lng")=="true") FExtension.store.set("SL_dictionary", FExtension.store.get("SL_dict"));
            ...
            if(FExtension.store.get("SL_TS")==null) FExtension.store.set("SL_TS", Date.now());
	    ...
	    if(FExtension.store.get("SL_DICT_PRESENT")==null) FExtension.store.set("SL_DICT_PRESENT", FExtension.store.SL_PR_KEYS);
	    ...
	    if(FExtension.store.get("AVOIDAUTODETECT")==null) FExtension.store.set("AVOIDAUTODETECT", 0);
	    if(FExtension.store.get("AVOIDAUTODETECT_LNG")==null) FExtension.store.set("AVOIDAUTODETECT_LNG", "");
    ...
    loadPrefs : function(){
        ...
        for(var i = 0; i < data.length; i++){
            ...
            result = FExtension.store.getValueByIndex("SL_session", i, data, result);
	    ...
	    //FORMER OPTIONS CS
            ...
            result = FExtension.store.getValueByIndex("AVOIDAUTODETECT_LNG", i, data, result);
            result = FExtension.store.getValueByIndex("AVOIDAUTODETECT_LNG", i, data, result);
    ...
    setDefault: function(){
	    ...
	    FExtension.store.set("SL_session", 0);
 	    ...
 	    //------------------------------- History ------------------------------------
	    if(FExtension.store.get("SL_History")==null) FExtension.store.set("SL_History", "");
	    if(FExtension.store.get("SL_TH_1")==null) FExtension.store.set("SL_TH_1", "0");
	    if(FExtension.store.get("SL_TH_2")==null) FExtension.store.set("SL_TH_2", "0");
	    if(FExtension.store.get("SL_TH_3")==null) FExtension.store.set("SL_TH_3", "0");
	    if(FExtension.store.get("SL_TH_4")==null) FExtension.store.set("SL_TH_4", "0");


            //------------------------------- option gt ----------------------------------
	    if(FExtension.store.get("SL_global_lng")==null) FExtension.store.set("SL_global_lng", "true");
	    if(FExtension.store.get("SL_Fontsize")==null) FExtension.store.set("SL_Fontsize", "17px");
	    if(FExtension.store.get("SL_langSrc")==null) FExtension.store.set("SL_langSrc", "auto");
	    if(FExtension.store.get("SL_langDst")==null) FExtension.store.set("SL_langDst", FExtension.store.SL_BR_LN);
	    if(FExtension.store.get("SL_no_detect")==null) FExtension.store.set("SL_no_detect", "true");
	    if(FExtension.store.get("SL_other_gt")==null) FExtension.store.set("SL_other_gt", "1");
	    if(FExtension.store.get("SL_dict")==null) FExtension.store.set("SL_dict", "true");
	    if(FExtension.store.get("SL_show_back")==null) FExtension.store.set("SL_show_back", "false");
	    if(FExtension.store.get("SL_show_back2")==null) FExtension.store.set("SL_show_back2", "false");
	    if(FExtension.store.get("SL_HKset")==null) FExtension.store.set("SL_HKset", "3|90|true");
	    if(FExtension.store.get("SL_HKset_inv")==null) FExtension.store.set("SL_HKset_inv", "3|90|true");
	    if(FExtension.store.get("SL_langDst_name")==null) FExtension.store.set("SL_langDst_name", "Spanish");

	    //??
	    if(FExtension.store.get("SL_Flag")==null)	    FExtension.store.set("SL_Flag", "FALSE");

            //------------------------------- option bbl ---------------------------------
	    if(FExtension.store.get("SL_ENABLE")==null) 	     FExtension.store.set("SL_ENABLE", "true");
	    if(FExtension.store.get("SL_show_button_bbl")==null)     FExtension.store.set("SL_show_button_bbl", "true");
	    if(FExtension.store.get("SL_global_lng_bbl")==null)      FExtension.store.set("SL_global_lng_bbl", "true");
	    if(FExtension.store.get("SL_Fontsize_bbl")==null)        FExtension.store.set("SL_Fontsize_bbl", "14px");
	    if(FExtension.store.get("SL_langSrc_bbl")==null)         FExtension.store.set("SL_langSrc_bbl", "auto");
	    if(FExtension.store.get("SL_langDst_bbl")==null)         FExtension.store.set("SL_langDst_bbl", FExtension.store.SL_BR_LN);
	    if(FExtension.store.get("SL_no_detect_bbl")==null)       FExtension.store.set("SL_no_detect_bbl", "true");
	    if(FExtension.store.get("SL_other_bbl")==null)           FExtension.store.set("SL_other_bbl", "1");
	    if(FExtension.store.get("SL_dict_bbl")==null)            FExtension.store.set("SL_dict_bbl", "true");
	    if(FExtension.store.get("SL_translation_mos_bbl")==null) FExtension.store.set("SL_translation_mos_bbl", "true");
	    if(FExtension.store.get("SL_pin_bbl")==null)             FExtension.store.set("SL_pin_bbl", "false");
	    ...
	    if(FExtension.store.get("SL_Delay")==null)               FExtension.store.set("SL_Delay", "0");
            ...
            //------------------------------- option it ----------------------------------
	    if(FExtension.store.get("SL_langSrc_it")==null)          FExtension.store.set("SL_langSrc_it", "auto");
	    if(FExtension.store.get("SL_langDst_it")==null)          FExtension.store.set("SL_langDst_it", FExtension.store.SL_BR_LN);
	    if(FExtension.store.get("SL_global_lng_it")==null)       FExtension.store.set("SL_global_lng_it", "true");
	    if(FExtension.store.get("SL_style")==null)               FExtension.store.set("SL_style", "239e23");
	    if(FExtension.store.get("SL_inject_brackets")==null)     FExtension.store.set("SL_inject_brackets", "true");
	    if(FExtension.store.get("SL_inject_before")==null)       FExtension.store.set("SL_inject_before", "false");
	    if(FExtension.store.get("SL_line_break")==null)          FExtension.store.set("SL_line_break", "false");
	    if(FExtension.store.get("SL_whole_word")==null)          FExtension.store.set("SL_whole_word", "true");
	    if(FExtension.store.get("SL_hide_translation")==null)    FExtension.store.set("SL_hide_translation", "false");
	    if(FExtension.store.get("SL_dictionary")==null)          FExtension.store.set("SL_dictionary", "true");
	    if(FExtension.store.get("SL_no_detect_it")==null)        FExtension.store.set("SL_no_detect_it", "true");
	    if(FExtension.store.get("SL_other_it")==null)            FExtension.store.set("SL_other_it", "1");
	    if(FExtension.store.get("SL_langDst_name_it")==null)     FExtension.store.set("SL_langDst_name_it", "Spanish");
	    if(FExtension.store.get("SL_FK_box1")==null)             FExtension.store.set("SL_FK_box1", "true");
	    if(FExtension.store.get("SL_FK_box2")==null)             FExtension.store.set("SL_FK_box2", "true");
            ...
            //------------------------------- option wpt ---------------------------------
	    if(FExtension.store.get("SL_global_lng_wpt")==null) FExtension.store.set("SL_global_lng_wpt", "true");
	    if(FExtension.store.get("SL_langSrc_wpt")==null) FExtension.store.set("SL_langSrc_wpt", "auto");
	    if(FExtension.store.get("SL_langDst_wpt")==null) FExtension.store.set("SL_langDst_wpt", FExtension.store.SL_BR_LN);
            if(FExtension.store.get("SL_other_wpt")==null) FExtension.store.set("SL_other_wpt", "1");
            if(FExtension.store.get("SL_langDst_name_wpt")==null) FExtension.store.set("SL_langDst_name_wpt", "Spanish");
